...
class Dataset(object):
  ...
  def __init__(self,
    ...
    """
    # data_file_name = 'policy_eval/trajectory_datasets/Reacher-v2/0/dualdice_None.pckl'
    ...
    for i in range(len(dataset["trajectories"]["masks"])):
      dataset["trajectories"]["masks"][i] = np.ones(dataset["trajectories"]["masks"][i].shape[0], dtype=np.float32)
